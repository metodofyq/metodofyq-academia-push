// Carga la estructura de Tema 50 (niveles 0, 1, 2, 3) en Supabase
// Uso: npx tsx scripts/seed-tema50-estructura.ts
...
async function main() {
  const file = path.join(process.cwd(), "scripts/data/tema50-estructura.json");
  ...
  console.log(`📚 Cargando Tema 50 (${raw.titulo})...`);
  ...
  console.log(`✅ Tema 50 completamente cargado.`);
}
